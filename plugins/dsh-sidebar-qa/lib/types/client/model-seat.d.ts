...
export type ModelSeatConfig = Pick<SidebarqaConfigView, 'answerProvider' | 'answerModel' | 'answerReasoningEffort'>;
 ...
 */
export declare function resolveModelSeat(input: ModelSeatInput): ModelSeatBinding;
