...
export declare function paneIdsOf(node: SidebarqaPaneNode): string[];
/**
 ...
 */
export declare function expandPatch(state: SidebarqaPanelState, viewportWidth: number | undefined): SidebarqaPanelPatch | null;
/**
 ...
 */
export declare function expandPanelIfCollapsed(store: SidebarqaSidebarStore, viewportWidth?: number): boolean;
