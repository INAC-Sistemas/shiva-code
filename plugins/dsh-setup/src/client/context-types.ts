 ...
 * members this half touches — the slot registry and the login session — and
 ...
 * @module dsh-setup/client/context-types
 */
...
/** The read face of `ctx.loginSession`, published by dsh-login. */
export interface LoginSessionFace {
  ...
  /**
   * The current session.
   * @returns a session object while signed in, or null.
   */
  getSnapshot(): unknown
}
