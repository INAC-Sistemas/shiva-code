...
**Start a Web artifact watcher from `pnpm dsh`.** This would keep client-plugin bundles current but changes a one-shot launcher into an owner of another long-lived process. Rebuilding is a separate, explicit step.
