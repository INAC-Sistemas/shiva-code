...
the VPS library seed can recreate the same skills on every deploy. Bundles are
grouped by category folder: `skills/<category>/<name>/SKILL.md`, with every
current skill under `system-development/`.
